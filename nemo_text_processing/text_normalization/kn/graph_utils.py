...
# Kannada fractional number patterns (similar to Hindi dedh/dhai)
KN_ONDU_VARE = "ಒಂದೂವರೆ"  # 1.5
KN_ERADU_VARE = "ಎರಡೂವರೆ"  # 2.5
...
MINUS = pynini.union(" ಋಣಾತ್ಮಕ ", " ಮೈನಸ್ ").optimize()  # Kannada for "negative" or "minus"
