...
from nemo_text_processing.text_normalization.kn.verbalizers.punctuation import PunctuationFst
...
class VerbalizeFinalFst(GraphFst):
    """
    Finite state transducer that verbalizes an entire sentence in Kannada, e.g.
    tokens { cardinal { integer: "ಇಪ್ಪತ್ತಮೂರು" } } -> ಇಪ್ಪತ್ತಮೂರು
    ...
    def __init__(self, deterministic: bool = True, cache_dir: str = None, overwrite_cache: bool = False):
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            punct = PunctuationFst(deterministic=deterministic).fst
